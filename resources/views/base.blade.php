<!DOCTYPE html>
    ...
    <body>
        ...
        <main>
            ...
            <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 sm:mt-[9.29em]" aria-label="Sidebar">
