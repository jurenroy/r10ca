...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="{{ asset('images/ca-logo.png') }}" type="image/x-icon">
        <title>CA | Add New User</title>
                            ...
                            <div class="lg:flex lg:flex-wrap">
                                ...
                                <div class="px-4 md:px-0 lg:w-full">
                                    <div class="md:mx-3 md:p-6">
                                        <form>
                                            <p class="mb-4 font-bold">New account</p>
                                            <!-- Username -->
                                            ...
                                            <div class="relative z-0 w-full mb-6 group">
                                                ...
                                                <span class="error-message flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1" id="confirm_password-error"></span>
                                            </div>
